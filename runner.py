...
from diferencial.runners.diferencial import Diferencial
from diferencial.runners.publish_test import PublishTest
from diferencial.runners.test_janitor import TestJanitor

PROGRAM_NAME = "Diferencial"
CLI_NAME = "diff"
...
COMMAND_MAP = {
    ...
    "run": (Diferencial, "Runs the application"),
